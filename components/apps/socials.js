...
export function Socials() {
    const socialLinks = [
        ...
        {
            name: "Instagram",
            url: "https://www.instagram.com/rawx18.dev",
    ...
    return (
        <div className="w-full h-full flex flex-col bg-ub-cool-grey text-white select-none">
            <div className="flex items-center justify-between w-full bg-ub-warm-grey bg-opacity-40 text-sm">
                <span className="font-bold ml-2">Social Links</span>
            </div>
            <div className="flex-grow flex flex-wrap items-center justify-center gap-8 p-8 overflow-y-auto">
                {socialLinks.map((social, index) => (
                    ...
                    >
                        <div className={`w-20 h-20 rounded-full ${social.color} flex items-center justify-center shadow-lg mb-3`}>
                            {social.icon}
                        </div>
            ...
            <div className="w-full bg-ub-warm-grey bg-opacity-40 text-sm p-2 text-center text-gray-300">
